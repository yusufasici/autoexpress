      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-card/80 border border-border rounded-xl p-5 flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-green-100 flex items-center justify-center mt-1">
              ...
              <div>
                <div className="font-bold text-green-700 text-base mb-1">WhatsApp Message</div>
